...
contract QuoterV2 is IQuoterV2, ISdexV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ISdexV3Pool) {
        return ISdexV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc ISdexV3SwapCallback
    function sdexV3SwapCallback(
        ...
        ISdexV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ISdexV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
